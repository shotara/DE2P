...
public class FeedSeries {
	...
	public FeedSeries(int deepFeedSeriesNo, int deepFeedNo, int deepMemberNo, int deepFeedSeriesId,
			int deepFeedSeriesOrder, long deepFeedSeriesCreateDate, String deepFeedSeriesName) {
		super();
		this.deepFeedSeriesNo = deepFeedSeriesNo;
		this.deepFeedNo = deepFeedNo;
		this.deepMemberNo = deepMemberNo;
