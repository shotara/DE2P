...
public class GlobalValue {
	...
	// AWS Bucket 경로
	public static final String AWS_S3_USER_BUCKET_URL = "https://s3.ap-northeast-2.amazonaws.com/deep-seoul";
	public static final String AWS_CLOUDFRONT_USER_BUCKET_URL = "d38huxvh50tsjl.cloudfront.net";
	public static final String AWS_UPLOAD_BUCKET_NAME = "deep-seoul";
