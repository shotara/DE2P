...
<meta name="description"
	content="랭크리는 유튜브 채널의 비즈니스 정보를 제공합니다. 유튜브 채널 마케팅을 고민하고 있다면 랭크리에서 채널정보를 확인하세요">
	...
	<div class="container pTop2">
		<div class="row">
			<div class="col">
				...
				<div class="corp-Middle-area inline-block">
					<div class="corp-headerTitle">영상 콘텐츠 보고서 (0 건)</div>

					<div class="pTop3 row">
						<div class="col float-left">등록일자</div>
						<div class="col float-left">채널명</div>
						<div class="col float-left">콘텐츠 URL</div>
						<div class="col float-left">상태</div>
					</div>
					...
					<c:if test="${outputReviewList.size() != 0}">
						<div class="none-MyReview txt-center">
							<div class="common-alert-txt">
								보고서 작성을 요청한 내역이 없습니다. <br /> 지금 유튜브 영상의 URL을 입력하고 일일/주간/월간 보고서를 받아보세요!
							</div>
							<div class="go-write-review">
								<button class="common-wide20Reverse-Btn"
									onclick="location.href='/02_page/Review/review.jsp'">콘텐츠 보고서 요청</button>
							</div>
						</div>
					</c:if>
					<!-- end non-channel review -->
